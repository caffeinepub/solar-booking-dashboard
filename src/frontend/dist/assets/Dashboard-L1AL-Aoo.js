...
function AddEditProjectModal({
  ...
  const totalReceived = (Number(bookingAmount) || 0) + (Number(financeAmount1) || 0) + (Number(financeAmount2) || 0) + (Number(cashAmount2) || 0);
                    ...
                    render: ({ field }) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                      Select,
                      {
                        ...
                        children: [
                          ...
                          /* @__PURE__ */ jsxRuntimeExports.jsx(SelectContent, { children: ODISHA_DISTRICTS.map((d) => /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: d, children: d }, d)) })
                        ]
                      }
                    )
                  }
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx(FormField, { label: "Employee Name", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                  Controller,
                  {
                    ...
                    render: ({ field }) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                      ...
                      {
                        value: field.value ?? "",
                        onChange: (v2) => setValue("employeeName", v2),
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx(FormField, { label: "Freelancer Name", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                  Controller,
                  {
                    ...
                    render: ({ field }) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                      ...
                      {
                        value: field.value ?? "",
                        onChange: (v2) => setValue("freelancerName", v2),
...
function downloadTemplate$1() {
  const rows = [
    TEMPLATE_HEADERS.join(","),
    TEMPLATE_EXAMPLE.map((v2) => `"${v2}"`).join(",")
  ];
  const csv = rows.join("\n");
...
function parseDate(val) {
  ...
  return Number.isNaN(d.getTime()) ? void 0 : d.toISOString().split("T")[0];
}
...
function buildProject(row, headers, slNo) {
  ...
  const rawStatus = (get2("status") ?? "OPEN").toUpperCase();
  const validStatuses = [
    "OPEN",
    "ONGOING",
    "CLOSED",
  ...
  const rawStage = get2("current stage");
  const validStages = [
    "Registration",
    "Digital Approval",
    "Material Delivery",
  ...
  return {
    ...
    invoiceNo: get2("invoice number"),
    consumerAcNo: get2("ac no"),
    remarks: get2("remarks"),
    pendingAmount
  };
}
...
function ProjectDrawer({
  ...
  const totalReceived = project ? (project.bookingAmount ?? 0) + (project.financeAmount1 ?? 0) + (project.financeAmount2 ?? 0) + (project.cashAmount2 ?? 0) : 0;
  const computedPending = project ? (project.salePrice ?? 0) - totalReceived : 0;
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    Sheet,
    {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "tr",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-3 py-2 text-right tabular-nums text-sm", children: project.pendingAmount != null && project.pendingAmount > 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-accent font-semibold", children: fmt(project.pendingAmount) }) : project.pendingAmount === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "[color:var(--stat-closed)] text-xs font-medium", children: "Cleared" }) : /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-muted-foreground", children: "—" }) }),
    ...
    "div",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { className: "flex-1 max-w-screen-2xl mx-auto w-full px-4 sm:px-6 py-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-7 gap-3 mb-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              StatCard,
              {
